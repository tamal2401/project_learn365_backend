...
public class SpecialOfferings  extends BaseEntity{
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "specialOfferings_generator")
    @SequenceGenerator(name="specialOfferings_generator", sequenceName = "specialOfferings_seq")
    private Long id;
